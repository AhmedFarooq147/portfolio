            ...
            <section className="text-gray-300 body-font  w-[100%] bg-fixed bg-gray-900 ">
                <div className="container mx-auto flex px-5 py-24 pl-28 pr-20 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <p className="sm:mb-8 md:ml-0 ml-8 mb-8">
                        ...
                        <div className="flex justify-center">
                        <Link href={"#Contact"}>
                            <button className="inline-flex text-white  ml-8 md:ml-0 bg-cyan-500 hover:bg-cyan-600 transition-all border-0 py-2 px-6 focus:outline-none rounded text-lg">
                                Contact Me!
                            </button></Link>
                    ...
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                        <Image
                            className="object-cover h-[400px] w-[300px] ml-8 md:ml-0 object-center rounded-3xl"
                            alt="hero"
                            src={logo}
                        />
                    </div>
